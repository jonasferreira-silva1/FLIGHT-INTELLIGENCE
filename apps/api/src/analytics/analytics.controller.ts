...
export class AnalyticsController {
  ...
  @ApiOperation({
    ...
    description:
      'Retorna estatísticas agregadas do tráfego aéreo de hoje no Recife (voos totais, taxa de pontualidade, atraso médio, etc).',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Retorna a lista de companhias aéreas ativas no aeroporto com o número total de voos e pontualidade percentual.',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Retorna dados em matriz representando o atraso médio de voos agrupados por hora do dia e dia da semana.',
  })
  @ApiResponse({
    status: 200,
